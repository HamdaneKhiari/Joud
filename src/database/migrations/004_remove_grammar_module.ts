/**
 * Migration 004 : supprime toutes les traces du module grammar
 * (données résiduelles des anciennes migrations) et la famille
 * grammar_detective (word_games).
 */
...
export default createMigration(
  ...
  async (db: SQLite.SQLiteDatabase) => {
    ...
    console.log('[Migration 004] ✓ Module grammar + famille grammar_detective supprimés de la base');
  }
);