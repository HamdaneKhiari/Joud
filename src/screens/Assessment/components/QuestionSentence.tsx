/**
 * ============================================
 * QUESTION SENTENCE (TypeScript + White Label)
 * Question avec passage de texte + choix multiples
 * ============================================
 */
...
import type { AssessmentSentenceQuestion } from '../schema';
...
export interface QuestionSentenceProps {
  question: AssessmentSentenceQuestion;
